    ...
    <div className="py-20 lg:py-28">
      <div className="container">
        ...
        <div className="mt-20 flex flex-col gap-8"> 
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 lg:cols-grid-3 gap-8">
            <Card className="h-[320px] p-0 flex flex-col md:col-span-3 lg:col-span-3">
              <CardHeader 
                title="Beyond the Code" 
                description="Explore my intrests and hobbies  beyond the digital realms." 
                className="px-6 py-6"
              />
